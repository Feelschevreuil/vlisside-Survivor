...
namespace vlissides_bibliotheque
{
    public static class boutiqueCA
    {
        ...
        public static List<Cours> CoursEnTourisme()
        {
        ...
        public static List<Cours> CoursEnSciencesNature()
        {
            List<Cours> listCours = new();
        ...
        public static List<Cours> CoursEnEducationSpecialisee()
        {
            List<Cours> listCours = new();
        ...
        public static List<Cours> CoursEnGenieMecanique()
        {
            List<Cours> listCours = new();
