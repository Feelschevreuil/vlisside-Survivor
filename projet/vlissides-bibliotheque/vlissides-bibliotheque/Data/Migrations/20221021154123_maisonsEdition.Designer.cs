...
namespace vlissides_bibliotheque.Migrations
{
    ...
    [Migration("20221021154123_maisonsEdition")]
    partial class maisonsEdition
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vlissides_bibliotheque.Models.LivreBibliotheque", b =>
                {
                    ...
                    b.Property<int>("MaisonsEditionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("vlissides_bibliotheque.Models.MaisonsEdition", b =>
                {
                    b.Property<int>("MaisonsEditionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MaisonsEditionId"), 1L, 1);

                    b.Property<string>("Nom")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("MaisonsEditionId");
            ...
            modelBuilder.Entity("vlissides_bibliotheque.Models.Utilisateur", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOr9zKl1qkaVmS6X2GEuWIlgnphMIHOf89O+sjxMyQNVw6cD0wvPRSaMn90e9XX4wQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "01e96cd5-4712-4d02-8401-a0f40db8d320",
            ...
            modelBuilder.Entity("vlissides_bibliotheque.Models.LivreBibliotheque", b =>
                {
                    b.HasOne("vlissides_bibliotheque.Models.MaisonsEdition", "MaisonsEdition")
                        .WithMany()
                        .HasForeignKey("MaisonsEditionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MaisonsEdition");
                });
