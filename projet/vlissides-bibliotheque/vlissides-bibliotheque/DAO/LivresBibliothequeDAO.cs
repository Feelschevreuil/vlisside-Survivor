...
namespace vlissides_bibliotheque.DAO
{
    ...
    public class LivresBibliothequeDAO : IDAO<LivreBibliotheque>, 
        IDAORecherchable<LivreBibliotheque>, 
        IDAORecherchableAvancee<LivreBibliotheque, 
        LivreChampsRecherche>, IDAORecherchableSuggestions
    {
        ...
        )
        {
            ...
            if
            (
                livreChampsRecherche.Neuf && 
                livreChampsRecherche.Digital && 
                livreChampsRecherche.Usage
            )
            {
